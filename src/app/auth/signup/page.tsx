        ...
        <div className="relative w-full max-w-md text-center">
          ...
          <div className="rounded-2xl border border-white/10 bg-white/5 p-8 backdrop-blur-sm">
            ...
            <p className="mt-2 text-white/60">
              Vi har skickat en bekräftelselänk till <strong className="text-white">{email}</strong>. Klicka på länken för att aktivera ditt konto.
            </p>
            <Link
              href="/auth/login"
              className="mt-6 inline-block text-sm font-medium text-purple-400 hover:text-purple-300 transition"
            >
    ...
    <div className="flex min-h-screen items-center justify-center bg-[#0A0A0B] px-4 text-white">
      ...
      <div className="relative w-full max-w-md">
        <div className="mb-8 text-center">
          ...
          <h1 className="mt-6 text-2xl font-bold">Skapa ditt konto</h1>
          <p className="mt-2 text-white/60">Börja skicka dokument gratis</p>
        </div>
        ...
        <div className="rounded-2xl border border-white/10 bg-white/5 p-8 backdrop-blur-sm">
          ...
          <p className="mt-4 text-center text-xs text-white/40">
            ...
            <Link href="/terms" className="underline hover:text-white/60 transition">
              Användarvillkor
            </Link>{' '}
            och{' '}
            <Link href="/privacy" className="underline hover:text-white/60 transition">
              Integritetspolicy
            </Link>
            .
          </p>
